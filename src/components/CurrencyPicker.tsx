    ...
    <>
      ...
      >
        <View>
          ...
          {selected && (
            <Text style={{ fontSize: 12, color: C.muted, marginTop: 2 }}>{selected.name}</Text>
          )}
        </View>
      ...
      <Modal visible={visible} animationType="slide" transparent onRequestClose={() => setVisible(false)}>
        <View style={{ flex: 1, backgroundColor: 'rgba(0,0,0,0.7)' }}>
          <Pressable style={{ flex: 0.25 }} onPress={() => setVisible(false)} />
          <View
            style={{
              flex: 0.75,
          ...
          >
            ...
            >
              <Text style={{ fontSize: 17, fontWeight: '700', color: C.text }}>Select Currency</Text>
                ...
                return (
                  <Pressable
                    ...
                    style={{
                      ...
                      backgroundColor: active ? C.accent + '0d' : 'transparent',
                    }}
                  >
                    <View>
                      <Text style={{ fontSize: 14, fontWeight: '700', color: active ? C.accent : C.text }}>
                        {item.code}
                      </Text>
                      <Text style={{ fontSize: 12, color: C.muted, marginTop: 2 }}>{item.name}</Text>
                    </View>
